    ...
    return(
        <LinearGradient colors={["#541B8B", "#14035C"]} style={styles.rootContainer}>
            <View style={styles.subcontainer}>
                <CurrencyItem icon="attach-money" currentValue="26,34" deltaValue="%-3,14" size={24} color={AppColors.yellow} isIncreasing={false} currencyName="DOLAR"/>
            ...
            <View style={styles.subcontainer}>
                ...
                <CurrencyItem icon="currency-bitcoin" currentValue="1,672" deltaValue="%1,94" size={24} color={AppColors.yellow} isIncreasing={true} currencyName="ETHEREUM"/>
                <CurrencyItem icon="currency-bitcoin" currentValue="7721,74" deltaValue="%1,57" size={24} color={AppColors.yellow} isIncreasing={true} currencyName="BIST"/>
            </View>
        </LinearGradient>
    );
}
