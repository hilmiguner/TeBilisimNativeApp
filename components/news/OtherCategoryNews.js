...
// Oluşturulan Öğeler
import ThreeCategoryNews from "./ThreeCategoryNews";
import BorderButton from "../BorderButton";

// React Native Hooks
import { useState } from "react";

function OtherCategoryNews({ newsData }) {
    ...
    content = showingNews.map((data, index) => <View key={index}><ThreeCategoryNews data={data}/></View>);
...
export default OtherCategoryNews;
