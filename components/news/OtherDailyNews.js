...
// Oluşturulan Öğeler
import ThreeDailyNews from "./ThreeDailyNews";
import BorderButton from "../BorderButton";

// React Native Hooks
import { useState } from "react";

function OtherDailyNews({ newsData }) {
    ...
    content = showingNews.map((data, index) => <View key={index}><ThreeDailyNews data={data}/></View>);
