...
// Oluşturulan Öğeler
import ThreeLocalNews from "./ThreeLocalNews";
import BorderButton from "../BorderButton";

// React Native Hooks
import { useState } from "react";

function OtherLocalNews({ newsData }) {
    ...
    content = showingNews.map((data, index) => <View key={index}><ThreeLocalNews data={data}/></View>);
