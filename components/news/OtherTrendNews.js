...
// Oluşturulan Öğeler
import ThreeTrendNews from "./ThreeTrendNews";
import BorderButton from "../BorderButton";

// React Native Hooks
import { useState } from "react";

function OtherTrendNews({ newsData }) {
    ...
    content = showingNews.map((data, index) => <View key={index}><ThreeTrendNews data={data}/></View>);
